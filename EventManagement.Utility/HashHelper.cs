...
/// <summary>
/// Hashing data with salt using MD5 and several SHA algorithms.
/// </summary>
namespace EventManagement.Utility
{
    ...
    {
        /// <summary>
        /// Provide Hash string for a given plainText using SHA256 also.
        /// </summary>
        /// <param name="plainText"></param>
        /// <returns></returns>
        public static string ComputeHashSHA256(string plainText)
        {
            return ComputeHash(plainText, _sha256, null);
        }

        /// <summary>
        /// Retun true if given plainText hash match with hashValue.
        /// </summary>
        /// <param name="plainText"></param>
        /// <param name="hashValue"></param>
        /// <returns></returns>
        public static bool VerifyHashSHA256(string plainText, string hashValue)
        {
            return VerifyHash(plainText, _sha256, hashValue);
        }
        ...
        const string _sha1 = "SHA1";
        const string _sha256 = "SHA256";
        const string _sha384 = "SHA384";
        const string _sha512 = "SHA512";
